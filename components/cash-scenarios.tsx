        ...
        return (
          ...
          >
            <div className="flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-start sm:justify-between">
              ...
              <span className="inline-flex max-w-full flex-wrap items-center justify-center whitespace-normal rounded-full bg-primary-500/10 px-3 py-1 text-center text-xs font-semibold uppercase leading-snug tracking-wide text-primary-600 sm:self-start">
                {scenario.runway}
              </span>
            </div>
